...
def create_running_workout(workout_json: str) -> str:
    ...
    main_pace    = spec.get("main_pace")  # [fast, slow] — easy/long with pace zone

    use_raw = warmup_km is not None or cooldown_km is not None or main_km is not None
